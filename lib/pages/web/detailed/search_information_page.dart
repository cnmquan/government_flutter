...
class _SearchInformationPageState extends State<SearchInformationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isComingSoon) {
      ...
      return FutureBuilder<List<ResidentModel?>?>(
          future: UserController().getResidentsFromSearch(),
          builder: (context, snapshot) {
              ...
              return TemplateWidget(
                ...
                child: Padding(
                  ...
                  child: NotifyMessageWidget(
                    ...
                    message:
                        r'Hiện tại hệ thống đang xảy ra lỗi. Vui lòng thử lại sau.',
                  ),
                ),
              );
            }
            ...
            List<ResidentModel?> residents = snapshot.data!;
            return TemplateWidget(
              isSignIn: true,
              child: Padding(
                padding: const EdgeInsets.symmetric(vertical: 12),
